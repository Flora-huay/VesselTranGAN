...
if __name__ == '__main__':
    ...
    save_root = "/storage/huayun/dataset_split"
    # datas_root = "/Users/zhangshichang/work/zsc_project/MedicalProjects_data/"
    # save_root = "/Users/zhangshichang/work/zsc_project/MedicalProjects_data/"
    create_dir(save_root)

    h, w, c = 432, 432, 128

    patch = 128
    stride_list = [patch - 8, patch - 4]
    ...
    for ct_path in tqdm(ct_paths):
        ...
        for stride in tqdm(stride_list):
            count = split_ct_cta_to_patch_1(ct_data, cta_data, save_path, patch=patch, stride=stride)
            count_all += count
